...
import { verifyOtp } from '../controllers/verifyOtpController.js'; // Importing the OTP verification controller
...
router.post('/verify-otp', verifyOtp); // Route for verifying OTP during signup
